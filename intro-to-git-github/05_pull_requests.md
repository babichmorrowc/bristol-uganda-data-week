...
A pull request is a way for you to get the changes you've made to your code back into the original version of the repository. Let's say you've written some code on your branch to analyze the data. Once you push it to the repository, it's available on GitHub for your branch, but it isn't integrated into the main copy of the code. If you submit a pull request, however, your code can be pushed to the original repository.
...
1. Make sure all of your edits have been saved, committed, and pushed to the branch named after you and your partner (see instructions for **Typing --> Directing**).
